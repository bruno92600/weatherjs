...
/**
 * Render all weather data in html pa
...
export const updateWeather = function (lat, lon) {
  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    card.innerHTML = `
    <h2 class="title-2 card-title">Maintenant</h2>
              <div class="weapper">
      ...
      <h2 class="title-2" id="highlights-label">
        ...
        module.aqiText[aqi].message
                ...
                <div class="card card-sm highlight-card">
                  ...
                  <h3 class="title-3">Préssion atmosphérique</h3>

                  <div class="wrapper">

                    <span class="m-icon">air_wave</span>
    ...
    fetchData(url.forecast(lat, lon), function (forecast) {
       ...
       */
      forecastSection.innerHTML = `
      <h2 class="title-2" id="forecast-label">Prévision 5 jours</h2>
